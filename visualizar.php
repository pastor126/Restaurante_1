            ...
            <div class="container-visualizar">
                ...
                <div class="tabela">
                    ...
                    <div>
                        ...
                        <span><?php echo $altera[0]['data_criacao'] ?></span>
                    </div>
                    <div class="btns">
                        <button onclick="alterarPrato(<?php echo $altera[0]['codigo']; ?>);">Alterar</button>
                        <button onclick="excluirPrato(<?php echo $altera[0]['codigo']; ?>);" name="inserirPrt">Excluir</button>
